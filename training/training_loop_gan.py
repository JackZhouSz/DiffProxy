...
def get_normalizer(generator_name, normalization_type, batch_size, device):
    if normalization_type == 'norm':
        params = sbs_generators.generator_lookup_table[generator_name].get_params()
        normalizer = sbs_generators.SBSGenerators.get_normalizer(params, batch_size, device)
    elif normalization_type == 'std':
        params = sbs_generators.generator_lookup_table[generator_name].get_params()
        normalizer = sbs_generators.SBSGenerators.get_standarizer(params, batch_size, device)
    else:
        normalizer = None
