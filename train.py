...
def launch_training(c, desc, outdir, dry_run, no_gan):
    ...
    print(f'With GAN loss: {not no_gan}')
    print()
...
def main(**kwargs):
    ...
    c.loss_kwargs = dnnlib.EasyDict(class_name='training.loss_nogan.StyleGAN2Loss') if opts.no_gan else dnnlib.EasyDict(class_name='training.loss_gan.StyleGAN2Loss')
